...
export default function Legal() {
  return (
    <div className="min-h-screen bg-zinc-950 pt-20">
      <SEO
        title="Mentions Légales - Green IA CBD Shop"
        description="Consultez les mentions légales, conditions générales d'utilisation et avertissements légaux de Green IA CBD Shop."
        keywords="mentions légales CBD, CGU Green IA"
      />
      {/* Header */}
          ...
          >
            <div>
              ...
              <p className="text-zinc-400 leading-relaxed">
                Le site Green IA CBD Shop est édité par :<br />
                <strong>Raison sociale :</strong> Green IA SAS
                <br />
                ...
                Directeur]
                <br />
                <strong>Contact :</strong> contact@greenIA-cbd.fr
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-zinc-400 leading-relaxed">
                ...
                est la propriété exclusive de Green IA SAS, sauf mention
