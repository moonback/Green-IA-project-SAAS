                ...
                <div className="space-y-12">
                    ...
                    <div className="space-y-4">
                        ...
                        <p className="text-zinc-500 text-sm max-w-lg leading-relaxed">
                            Invitez vos amis à découvrir Green IA. Recevez <span className="text-white font-bold">{settings.referral_reward_points} Carats</span> lors de leur première commande payée.
                        </p>
                    </div>
                    ...
                    <div className="p-8 bg-zinc-900/50 rounded-3xl border border-white/5 space-y-4">
                        ...
                        <ul className="space-y-3">
                            {[
                                "Le filleul doit être un nouvel utilisateur Green IA.",
