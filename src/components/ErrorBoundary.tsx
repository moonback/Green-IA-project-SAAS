...
/**
 * Composant de Error Boundary global pour Green IA.
                ...
                <div className="min-h-screen bg-black flex items-center justify-center p-6 sm:p-10 relative overflow-hidden">
                    ...
                    >
                        ...
                        <p className="text-zinc-400 mb-10 leading-relaxed max-w-md mx-auto">
                            Une erreur inattendue est survenue dans l'application. Nos ingénieurs Green IA ont été notifiés (enfin, ils bossent déjà dessus !).
                        </p>
                        ...
                        <div className="mt-12 flex items-center justify-center gap-2 opacity-30 grayscale hover:grayscale-0 transition-all cursor-default group">
                            <img src="/logo.png" alt="Green IA" className="w-6 h-6 rounded-lg group-hover:rotate-12 transition-transform duration-500" />
                            <span className="text-[10px] font-black uppercase tracking-widest text-white">Green IA System</span>
                        </div>
                    </motion.div>
                </div>
            );
