      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        <div className="mb-14 text-center">
          <motion.h2
            ...
            viewport={{ once: true }}
            className="text-3xl font-serif font-bold text-white md:text-4xl"
          >
          ...
          {faqs.map((faq, index) => (
            ...
            >
              ...
              >
                ...
                <ChevronDown
                  className={`h-5 w-5 shrink-0 text-emerald-300 transition-transform duration-300 ${openIndex === index ? 'rotate-180' : ''}`}
                />
              </button>
              <AnimatePresence>
                {openIndex === index && (
                  ...
                  >
                    <div className="px-6 pb-5 leading-relaxed text-zinc-300">{faq.answer}</div>
                  </motion.div>
                )}
              </AnimatePresence>
            </motion.div>
