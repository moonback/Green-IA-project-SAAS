...
3. TRANSACTION : Demande la quantité puis confirme "Je l'ajoute à votre panier ?" avant d'utiliser l'outil 'add_to_cart'. Informe le client que la livraison est offerte dès ${deliveryFreeThreshold}€ d'achat (sinon ${deliveryFee.toFixed(2)}€).
